...
def main():
    ...
    parser.add_argument('data', type=str, help='EDGES dataset file (npz)')
    ...
    # STEP 2 PARAMS
    parser.add_argument('-m', '--margin', type=float, default=0.12, help='Margin value for ordinal loss (default: 0.12)')                                                                           
    ...
    parser.add_argument('-e2', '--nEpochs2', type=int, default=30, help='Number of epochs to train [STEP 2] (default: 30)')
    parser.add_argument('-l2', '--learningRate2', type=float, default=0.001, help='Initial learning rate [STEP 2] (default: 0.001)')
    parser.add_argument('-s2', '--stepRateEpochs2', type=int, default=10, help='Reduce LR after this number of epochs [STEP 2] (default: 10)')
